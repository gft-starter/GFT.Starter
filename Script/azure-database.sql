...
CREATE TABLE [ServiceOrders] (
    ...
    CONSTRAINT [FK_ServiceOrders_Cars_CarId] FOREIGN KEY ([CarId]) REFERENCES [Cars] ([Id]) ON DELETE CASCADE,
...
VALUES (N'20190515164901_AdicionandoTudo', N'2.2.4-servicing-10062');

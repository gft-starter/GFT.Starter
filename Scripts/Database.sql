...
CREATE TABLE [ServiceOrders] (
    ...
    CONSTRAINT [FK_ServiceOrders_Cars_VehicleId] FOREIGN KEY ([VehicleId]) REFERENCES [Cars] ([Id]) ON DELETE CASCADE
);
...
VALUES (N'20190515161407_Initial', N'2.2.4-servicing-10062');
